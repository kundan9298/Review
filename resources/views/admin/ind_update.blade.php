   ...
   <div class="app-content pt-3 p-md-3 p-lg-4">
      <div class="container-xl">
         <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
            <a class="flex-sm-fill text-sm-center nav-link active"  href="/admin/industry">Back</a>
         </nav>



         <form action="{{route('ind.update')}}" method="POST" enctype="multipart/form-data">
           @csrf
            <div class="form-group">
                ...
                <select class="form-control" id="exampleFormControlSelect1"  name="categroy" required>
                  ...
                  @if($data['category'] == 'food-beverage') 
                  ...
                  @elseif($data['category'] == 'media-entertainment') 
                  <option value="food-beverage">Food & Beverage</option>
                  <option value="media-entertainment" selected>Media & Entertainment</option>
                  <option value="education">Education</option>
                  <option value="health">Health</option>
                  <option value="real-estate">Real Estate</option>
                  <option value="retail">Retail</option>
                  ...
                  @elseif($data['category'] == 'real-estate') 
                  <option value="food-beverage">Food & Beverage</option>
                  <option value="media-entertainment">Media & Entertainment</option>
                  <option value="education">Education</option>
                  <option value="health">Health</option>
                  ...
                  @elseif($data['category'] == 'banking-finance') 
                  <option value="food-beverage">Food & Beverage</option>
                  <option value="media-entertainment">Media & Entertainment</option>
                  <option value="education">Education</option>
                  <option value="health">Health</option>
