   ...
   <div class="app-content pt-3 p-md-3 p-lg-4">
      <div class="container-xl">
         <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
            <a class="flex-sm-fill text-sm-center nav-link active"  href="feature">Back</a>
         </nav>



         <form action="featureadd" method="POST" enctype="multipart/form-data">
           @csrf
          ...
          <div class="form-group mt-3">
            ...
            <input type="text" class="form-control" id="slug" name="url" placeholder="Type URL Of webiste" required>
          </div>
          ...
          <div class="form-group mt-3">
            ...
            <input type="text" class="form-control" id="image-alt" name="image-alt" placeholder="Type Image Alt Name">
              ...
              <div class="form-group mt-3">
                ...
                <input type="text" class="form-control" id="exampleFormControlInput1" name="feature_company_name" placeholder="Enter Company Name">
              </div>

              <div class="form-group mt-3">
                <label for="meta-title">Feature Company Website</label>
                <input type="text" class="form-control" id="exampleFormControlInput1" name="feature_company_website" placeholder="Enter Company Website url">
              </div>

              <div class="form-group mt-3">
                <label for="meta-title">Feature Company People Name</label>
                <input type="text" class="form-control" id="exampleFormControlInput1" name="feture_people_name" placeholder="Enter Feature People Name">
              </div>

              <div class="form-group mt-3">
                <label for="meta-title">Feature Company People Position</label>
                <input type="text" class="form-control" id="exampleFormControlInput1" name="feature_people_position" placeholder="Enter Position Of feature ">
              </div>

              <div class="form-group mt-3">
                <label for="meta-title">Feature Company People Description</label>
                <input type="text" class="form-control" id="exampleFormControlInput1" name="feature_pepople_description" placeholder="Enter Company Description">
              </div>
              ...
              <div class="form-group mt-3">
                ...
                <input type="text" class="form-control" id="image-alt" name="logo-alt" placeholder="Type logo Alt Name">
                </div>
