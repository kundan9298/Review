   ...
   <div class="app-content pt-3 p-md-3 p-lg-4">
      <div class="container-xl">
         ...
         <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
            <a class="flex-sm-fill text-sm-center nav-link active"  href="magazine-add">Add Data</a>
         </nav>
                     ...
                     <div class="table-responsive">
                        <table class="table app-table-hover mb-0 text-left">
                           <thead>
                              <tr>  
                                 <th class="cell">Id</th>
                                 <th class="cell">Issue Name</th>
                                 <th class="cell">Issue Month</th>
                                 <th class="cell">Issue Year</th>
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="cell"><span class="truncate">{{$list->issue_name}}</span></td>
                                 <td class="cell">{{$list->issue_month}}</td>
                                 <td class="cell">{{$list->issue_year}}</td>
