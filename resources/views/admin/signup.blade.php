	    ...
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
				    <div class="app-auth-branding mb-4"><a class="app-logo" href="index.html"><img class="logo-icon me-2" src="{{asset('assets/images/favicon.png')}}" alt="logo"></a></div>
					<h2 class="auth-heading text-center mb-4">Sign up to Portal</h2>					
	
					<div class="auth-form-container text-start mx-auto">
						<form class="auth-form auth-signup-form" action="/admin/signup-form" method="POST"> 
							@csrf 
							...
							<div class="extra mb-3">
								<div class="form-check">
									<input class="form-check-input" type="checkbox" value="True" id="RememberPassword" name="RememberPassword">
		    ...
		    <div class="auth-background-overlay p-3 p-lg-5">
			    <div class="d-flex flex-column align-content-end h-100">
				    ...
				    <div class="overlay-content p-3 p-lg-4 rounded">
					    ...
					    <div>Global Radiance Review For business and technology professionals, the world's most trusted online and print network. Think-provoking CEOs, CIOs, CTOs, IT VPs and managers, as well as a slew of other IT professionals, make up our community. <a href="https://globalradiancereview.com/">here</a>.</div>
				    </div>
				</div>
