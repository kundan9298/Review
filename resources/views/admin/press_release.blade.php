   ...
   <div class="app-content pt-3 p-md-3 p-lg-4">
      <div class="container-xl">
         ...
         <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
            <a class="flex-sm-fill text-sm-center nav-link active"  href="press-release-addData">Add Data</a>
         </nav>
                        ...
                        <table class="table app-table-hover mb-0 text-left">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="cell">{{$list->category}}</td>
                              ...
                              <script>
                                 ...
                                 function deleteProfile{{$list->id}}() {
                                   if (confirm("Do you really want to delete your profile?")) {
                                       location.href = 'pressreleases_delete/{{$list->id}}';
                                   }
                               }

                               function updateProfile{{$list->id}}() {
                                   if (confirm("Do you really want to Update your profile?")) {
                                       location.href = 'pressreleases_update/{{$list->id}}';
                                   }
                               }
                               </script>
							  @endforeach
