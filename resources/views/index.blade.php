                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="bg-wrap">
                                            <div class="bg" data-bg="images/all/1.jpg" data-swiper-parallax="40%"></div>
                                ...
                                <div class="col-md-8">
                                    <div class="main-container fl-wrap fix-container-init">
                                        <div class="section-title">
                                            ...
                                            <div class="ajax-nav">
                                                <ul>
                                                    <li><a href="ajax/category1.html" class="current_page">World</a></li>
                                                    <li><a href="ajax/category2.html">Technology</a></li>
                                                    <li><a href="ajax/category3.html">Business</a></li>
                                                    <li><a href="ajax/category4.html">Sports</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="ajax-wrapper fl-wrap">
                                            <div class="ajax-loader"><img src="images/loading.gif" alt=""/></div>
                                                        ...
                                                        <div class="swiper-wrapper">
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="grid-post-item  bold_gpi  fl-wrap">
                                                                    <div class="grid-post-media gpm_sing">
                                                                        <div class="bg" data-bg="images/all/1.jpg"></div>
                                                                        <div class="author-link"><a href="author-single.html"><img src="images/avatar/1.jpg" alt="">  <span>Ann Kowalsky</span></a></div>
                                                                        <div class="grid-post-media_title">
                                                                            <a class="post-category-marker" href="category.html">Business</a>
